...
public class DefaultSearchQueryMetrics implements SearchQueryMetrics
{
  ...
  @Override
  public QueryMetrics reportCacheTime(long timeNs)
  {
    return delegateQueryMetrics.reportCacheTime(timeNs);
  }

  @Override
  public QueryMetrics reportCacheTimeResultLevel(long timeNs)
  {
    return delegateQueryMetrics.reportCacheTimeResultLevel(timeNs);
  }
